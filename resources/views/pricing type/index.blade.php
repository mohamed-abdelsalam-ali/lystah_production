...
@section('content')
    ...
    <div class="main-content">
        <div class="page-content">
            <h1 class="text-center text-info">Pricing Types
            </h1>
            <div class="row">
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="itemtbl" class="display table table-bordered dt-responsive dataTable dtr-inline"
                                ...
                                <thead>
                                    <tr>
                                        <th class="d-none">pricing_type_id</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit pricing_type</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('pricing_type.update', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        <label for="recipient-name" class="col-form-label"> pricing_type Name </label>
                                        <input name="pricing_type_id" id="pricing_type_id" type="hidden" class="form-control">
                                        <input name="type" id="pricing_type_name" type="text" class="form-control"
                                            required="">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <textarea name="desc" cols="30" rows="5" id="pricing_type_desc" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="staticBackdrop_delete" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Delete pricing_type</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('pricing_type.destroy', 'test') }}" method="post">
                    {{ method_field('Delete') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        <input id="pricing_type_id_delete" name="pricing_type_id" type="hidden" class=""
                                            required="">
                                        <label for="recipient-name" class="col-form-label"> سيتم حذف هذه الوحدة </label>

                                        <input id="pricing_type_name_delete" name="type" type="text"
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel"> Add New pricing_type </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('pricing_type.store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-body">
...
@section('js')
    ...
    <script>
        var all_pricing_types = {!! $all_pricing_types !!}
        var itemtbl = "";
        $(document).ready(function() {
            ...
            itemtbl.clear();
            itemtbl.rows.add(all_pricing_types).draw();
    ...
    <script>
        $('#itemtbl tbody').on('click', '.edit_item', function() {
            $("#pricing_type_id").val('');
            $("#pricing_type_name").val('');
            $("#pricing_type_desc").val('');

            var currentRow = $(this).closest("tr");
            $("#pricing_type_id").val(currentRow.find("td:eq(0)").text());
            $("#pricing_type_name").val(currentRow.find("td:eq(1)").text());
            $("#pricing_type_desc").val(currentRow.find("td:eq(2)").text());
        ...
        $('#itemtbl tbody').on('click', '.delete_item', function() {
            $("#pricing_type_id_delete").val('');
            $("#pricing_type_name_delete").val('');
            var currentRow = $(this).closest("tr");
            $("#pricing_type_id_delete").val(currentRow.find("td:eq(0)").text());
            $("#pricing_type_name_delete").val(currentRow.find("td:eq(1)").text());
