            ...
            <div class="layout-width">
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <form class="app-search d-none  dateTimeClock">
                        ...
                        <div class="dropdown topbar-head-dropdown ms-1 header-item kt_topbar_notifications_3"
                            ...
                            <button type="button" title="الإشعارات" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <div class="dropdown topbar-head-dropdown ms-1 header-item">
                            <button type="button" title="المخازن" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <div class="dropdown  topbar-head-dropdown header-item">
                            <button type="button" title="بحــث" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                                ...
                                <form action="#" id="searchAllFrom" class="p-3">
                                    <div class="form-group m-0">
                                        <div class="input-group">
                                            <input type="text" id="searchalllabl" class="form-control"
...
<div class="d-flex align-items-center">
                            <div class="ms-1 header-item d-none d-sm-flex">
                                <button type="button" title="تكبير الشاشة" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <div class="dropdown header-item ms-sm-3 nav-link topbar-user">
