...
<body class="cairo">
            ...
            <div class="layout-width">
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <!-- App Search-->
                        <form class="app-search d-none d-md-block dateTimeClock">
                            <div class="position-relative">

                                <h3>شركة الأمـــــل </h3>
                            </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown  topbar-head-dropdown header-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                               ...
                               <form action="#" id="searchAllFrom" class="p-3">
                                    <div class="form-group m-0">
                                        <div class="input-group">
                                            <input type="text" id="searchalllabl" class="form-control" placeholder="Search ..."
                                ...
                                <span class="d-flex align-items-center">
                                    @if (Auth::user()->profile_img)
                                        <img class="rounded-circle header-profile-user"
                                            ...
                                            alt="Header Avatar">
                                    @else
                                        <img src="{{ asset('users_images/default.png') }}" alt="user" />
                                    @endif
                        ...
                        @hasanyrole('super admin|admin')
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse"
                                    ...
                                    <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">الرئيسيـــة</span>
                                </a>
                                <div class="collapse menu-dropdown" id="sidebarDashboards">
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="#" class="nav-link"><span data-key="t-job">HR</span> <span
                        ...
                        @hasanyrole('super admin|admin|operation')
                            <li class="nav-item partli">
                                <a class="nav-link menu-link" href="#sidebarAppsPart" data-bs-toggle="collapse"
                                    ...
                                    <i class="bx bx-hive"></i> <span data-key="t-apps">قطع الغيار</span>
                                </a>
                                <div class="collapse menu-dropdown" id="sidebarAppsPart">
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item" id="partli">
                                            <a href="/parts" class="nav-link" data-key="t-calendar">إضافة قطع
                                                الغيــار</a>
                                        </li>
                                        <li class="nav-item" id="">
                                            <a href="/customSearch" class="nav-link" data-key="t-calendar">بحــث قطع
                                                الغيــار</a>
                                        </li>
                        ...
                        @hasanyrole('super admin|admin|stuff')
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarbills">
                                    <ul class="nav nav-sm flex-column">
                                                ...
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <a href="/storeManage" class="nav-link"><span
                                                                data-key="t-term-conditions"> إضافة فاتورة شراء </span>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="/xx" class="nav-link"><span
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="collapse menu-dropdown" id="sidebarsellbill">
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <a href="/xx" class="nav-link"><span
                                                                data-key="t-term-conditions"> إضافة فاتورة بيع </span> </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="/xx" class="nav-link"><span
                                        ...
                                        <li class="nav-item">
                                            <a href="/xx" target="_self" class="nav-link"
                                ...
                                <div class="collapse menu-dropdown" id="sidebarsupplier">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                         ...
                                         <li class="nav-item">
                                            <a href="/supplierStatment" class="nav-link" data-key="t-basic"> كشف حساب مورد
                                                  </a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="#sidebaraccountant" data-bs-toggle="collapse"
                                    ...
                                    <i class="mdi mdi-currency-usd"></i> <span
                                        data-key="t-layouts">الحسابــــــات</span>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebaremployee">
                                    <ul class="nav nav-sm flex-column" id="sidebaremployeeul">
                                        <li class="nav-item">
                                            <a href="/employee" class="nav-link" data-key="t-horizontal">الموظفين</a>
                                        </li>
                                                ...
                                                <ul class="nav nav-sm flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="auth-signin-cover.html" class="nav-link"
                                                            data-key="t-cover"> أرقام قطع الغيار </a>
                                                    </li>
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="#sidebarClass" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                data-key="t-signin"> تصنييف قطع الغيار
                                            </a>
                                            <div class="collapse menu-dropdown" id="sidebarClass">
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <a href="/groups" class="nav-link" data-key="t-faqs"> المجموعات
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="/sub_group" class="nav-link" data-key="t-pricing">المجمزعات الفرعية
                                                             </a>
                                                    </li>
    ...
    <div class="modal fade" id="infoMdl" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
     ...
     <div class="modal fade" id="searchAllModal"  tabindex="-1" aria-labelledby="searchAllModalLabel" aria-hidden="true">
    ...
    {{-- <script src="asetNew/js/jquery-3.5.1.js"></script> --}}
    {{-- <script src="js/timer.js"></script> --}}
    {{-- <script src="asetNew/js/jquery.dataTables.min.js"></script> --}}
    {{-- <script src="asetNew/js/dataTables.responsive.js"></script> --}}
    {{-- <script src="asetNew/js/dataTables.buttons.min.js"></script> --}}
    {{-- <script src="asetNew/js/buttons.print.min.js"></script> --}}
    {{-- <script src="asetNew/js/jszip.min.js"></script> --}}
    {{-- <script src="asetNew/js/pdfmake.min.js"></script> --}}
    {{-- <script src="asetNew/js/buttons.html5.min.js"></script> --}}

    {{-- <script src="asetNew/js/select2.min.js"></script> --}}
    {{-- <script src="asetNew/js/ag-grid-enterprise.min.js"></script> --}}
