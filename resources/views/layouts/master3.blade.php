                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarDashboards">
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item ">
                                            <a href="/get_stores_money_view" class="nav-link" data-key="t-crm"> Stores_money </a>
                                        </li>
                                    ...
                                    <div class="collapse menu-dropdown" id="sidebaraccountant">
                                        <ul class="nav nav-sm flex-column">
                                            ...
                                            @can('accounting_entries')
                                                ...
                                                <li class="nav-item">
                                                    <a href="/inv_qayd" class="nav-link" data-key="t-horizontal">   عرض الفواتير وتعديل القيود </a>
                                                </li>
                                            @endcan
                                ...
                                <div class="collapse menu-dropdown" id="sidebarservice">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        @endcan
                                         @can('new_service_bills')
                                        <li class="nav-item">
                                            <a href="/tawreedServices" class="nav-link"><span data-key="t-term-conditions">
