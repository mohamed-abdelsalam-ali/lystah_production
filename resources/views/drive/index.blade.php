...
@section('content')
    ...
    <div class="main-content">
        <div class="page-content">
            <h1 class="text-center text-info">Drives
            </h1>
            <div class="row">
                <div class="col">
                    <div class="card">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit drive</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('drive.update', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        <label for="recipient-name" class="col-form-label"> drive Name </label>
                                        <input name="drive_id" id="drive_id" type="hidden" class="form-control">
                                        <input name="name" id="drive_name" type="text" class="form-control"
                                            required="">
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="staticBackdrop_delete" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Delete drive</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('drive.destroy', 'test') }}" method="post">
                    {{ method_field('Delete') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        <input id="drive_id_delete" name="drive_id" type="hidden" class=""
                                            required="">
                                        <label for="recipient-name" class="col-form-label"> سيتم حذف هذه الوحدة </label>

                                        <input id="drive_name_delete" name="name" type="text"
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel"> Add New drive </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            itemtbl.clear();
            itemtbl.rows.add(all_drives).draw();
    ...
    <script>
        $('#itemtbl tbody').on('click', '.edit_item', function() {
            ...
            $("#drive_id").val(currentRow.find("td:eq(0)").text());
            $("#drive_name").val(currentRow.find("td:eq(1)").text());
            $("#drive_desc").val(currentRow.find("td:eq(2)").text());
        ...
        $('#itemtbl tbody').on('click', '.delete_item', function() {
            $("#drive_id_delete").val('');
            $("#drive_name_delete").val('');
            var currentRow = $(this).closest("tr");
            $("#drive_id_delete").val(currentRow.find("td:eq(0)").text());
            $("#drive_name_delete").val(currentRow.find("td:eq(1)").text());
