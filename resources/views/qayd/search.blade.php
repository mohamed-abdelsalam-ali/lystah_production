...
<main role="main" class="main-content ">
    <div class="page-content pb-1  ">
        <div class="mb-4">
            <h1 class="text-center font1"> بحث بالقيد </h1>
        </div>

    <form action="{{url('getallAccount')}}" method="POST" >
        @csrf
        <div class="row form-group   mb-2">
            <label class="col-lg-2 col-form-label font1"> من
            </label>
            <div class="col-lg-4">
                <input id="dateQaydfrom" name="dateQaydfrom" type="date" placeholder="الاسم باللغة العربية " class="form-control">
    ...
    <div class="mb-4">
        ...
        <label class="col-lg-2 font1">
            @if ($accounts) {{ $accounts[0]->branch_tree->name}}
            @else
                ...
                <table class="table table-striped  table-bordered border-light  text-center justify-content-center">
                    <thead class="border-light text-center">
                        <tr class="h">
                            ...
                            <th class="text-center">عرض القيد </th>
                          </tr>
                    ...
                    @foreach ( $accounts as $account )
                        <tr class="h">
                            ...
                            <td class="text-center"> {{ $account->qaydid }} </td>
