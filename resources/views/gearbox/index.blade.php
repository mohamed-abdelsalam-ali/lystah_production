...
@section('content')
    ...
    <div class="main-content">
        <div class="page-content">
            <h1 class="text-center text-info">Gear Boxes
            </h1>
            <div class="row">
                <div class="col">
                    <div class="card">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit gearbox</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('gearbox.update', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        <label for="recipient-name" class="col-form-label"> gearbox Name </label>
                                        <input name="gearbox_id" id="gearbox_id" type="hidden" class="form-control">
                                        <input name="gearname" id="gearbox_name" type="text" class="form-control"
                                            required="">
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="staticBackdrop_delete" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Delete gearbox</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('gearbox.destroy', 'test') }}" method="post">
                    {{ method_field('Delete') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        <input id="gearbox_id_delete" name="gearbox_id" type="hidden" class=""
                                            required="">
                                        <label for="recipient-name" class="col-form-label"> سيتم حذف هذه الوحدة </label>

                                        <input id="gearbox_name_delete" name="name" type="text"
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel"> Add New gearbox </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('gearbox.store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-body">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        ...
                                        <label for="recipient-name" class="col-form-label"> gearbox Name </label>
                                        <input name="gearname" type="text" class="form-control" required="">
                                    </div>
...
@section('js')
    ...
    <script>
        var all_gearboxes = {!! $all_gearboxes !!}
        var itemtbl = "";
        $(document).ready(function() {
            ...
            itemtbl.clear();
            itemtbl.rows.add(all_gearboxes).draw();
    ...
    <script>
        $('#itemtbl tbody').on('click', '.edit_item', function() {
            ...
            $("#gearbox_id").val(currentRow.find("td:eq(0)").text());
            $("#gearbox_name").val(currentRow.find("td:eq(1)").text());
            $("#gearbox_desc").val(currentRow.find("td:eq(2)").text());
        ...
        $('#itemtbl tbody').on('click', '.delete_item', function() {
            $("#gearbox_id_delete").val('');
            $("#gearbox_name_delete").val('');
            var currentRow = $(this).closest("tr");
            $("#gearbox_id_delete").val(currentRow.find("td:eq(0)").text());
            $("#gearbox_name_delete").val(currentRow.find("td:eq(1)").text());
