    ...
    <div class="modal fade" id="staticBackdrop_edit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('unit.update', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        <input id="unit_id_delete" name="unit_id" type="hidden" class=""
                                            required="">
                                        <label for="recipient-name" class="col-form-label"> سيتم حذف هذه الوحدة </label>

                                        <input id="unit_name_delete" name="name" type="text"
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            itemtbl.clear();
            itemtbl.rows.add(all_units).draw();
    ...
    <script>
        $('#itemtbl tbody').on('click', '.edit_item', function() {
            ...
            $("#unit_id").val(currentRow.find("td:eq(0)").text());
            $("#unit_name").val(currentRow.find("td:eq(1)").text());
            $("#unit_desc").val(currentRow.find("td:eq(2)").text());
        ...
        $('#itemtbl tbody').on('click', '.delete_item', function() {
            ...
            $("#unit_name_delete").val(currentRow.find("td:eq(1)").text());
