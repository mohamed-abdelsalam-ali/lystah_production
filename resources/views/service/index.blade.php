...
@section('content')
    ...
    <div class="main-content">
        <div class="page-content">
            <h1 class="text-center text-info">Services
            </h1>
            <div class="row">
                <div class="col">
                    <div class="card">
    ...
    <div class="modal fade" id="staticBackdrop_edit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('service.update', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        ...
                                        <input name="name" id="service_name" type="text" class="form-control"
                                            required="">
                                    </div>
                                </div>
                                ...
                                <input type="file" class="form-control" name="service_img" id="service_image_edit">
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        <input id="service_id_delete" name="service_id" type="hidden" class=""
                                            required="">
                                        <label for="recipient-name" class="col-form-label"> سيتم حذف هذه الوحدة </label>

                                        <input id="service_name_delete" name="name" type="text"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row pt-3 d-none" id="div_image_service">
                                    <img style="width: 200px; height: 100px;" class="add_logo_image" src=""
                                        class="rounded border" alt="">
                                </div>
                                <input type="file" class="form-control" id="add_logo" name="service_img">
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "render": function(data) {
                            if (data) {
                                return '<img  class="avatar-img img-thumbnail rounded-5 itemimg" src="service_images/' +
                                    data +
                                    '" width="40px">';
            ...
            itemtbl.clear();
            itemtbl.rows.add(all_services).draw();
    ...
    <script>
        $('#itemtbl tbody').on('click', '.edit_item', function() {
            ...
            $("#service_id").val(currentRow.find("td:eq(0)").text());
            $("#service_name").val(currentRow.find("td:eq(1)").text());
        ...
        $('#itemtbl tbody').on('click', '.delete_item', function() {
            $("#service_id_delete").val('');
            $("#service_name_delete").val('');
            var currentRow = $(this).closest("tr");
            $("#service_id_delete").val(currentRow.find("td:eq(0)").text());
            $("#service_name_delete").val(currentRow.find("td:eq(1)").text());
    ...
    <script>
        $('#service_image_edit').on('change', function() {
            var input = this;
            var url = $(this).val();
        ...
        $('#add_logo').on('change', function() {
            ...
            if (input.files && input.files[0] && (ext == "gif" || ext == "png" || ext == "jpeg" || ext == "jpg")) {
                var reader = new FileReader();
                reader.onload = function(e) {
                    $("#div_image_service").removeClass('d-none');
