...
@section('content')
    ...
    <div class="main-content">
        <div class="page-content">
            <h1 class="text-center text-info">All brand Types
            </h1>
            <div class="row">
                <div class="col">
                    <div class="card">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit brand_type</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('brand_type.update', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        <label for="recipient-name" class="col-form-label"> Brand Type Name </label>
                                        <input name="brand_type_id" id="brand_type_id" type="hidden" class="form-control">
                                        <input name="name" id="brand_type_name" type="text" class="form-control"
                                            required="">
                                    </div>
                                </div>
                                ...
                                <input type="file" class="form-control" name="brand_type_img" id="brand_type_image_edit">
                                <div class="row">
                                    <label for="recipient-name" class="col-form-label"> Description </label>
                                    <div class="col-12">
                                        <textarea name="desc" cols="30" rows="5" id="brand_type_desc" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="staticBackdrop_delete" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Delete brand_type</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('brand_type.destroy', 'test') }}" method="post">
                    {{ method_field('Delete') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        <input id="brand_type_id_delete" name="brand_type_id" type="hidden" class=""
                                            required="">
                                        <label for="recipient-name" class="col-form-label"> سيتم حذف هذا النوع  </label>

                                        <input id="brand_type_name_delete" name="name" type="text"
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel"> Add New Brand Type </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('brand_type.store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row pt-3 d-none" id="div_image_brand_type">
                                    <img style="width: 200px; height: 100px;" class="add_logo_image" src=""
                                        class="rounded border" alt="">
                                </div>
                                <input type="file" class="form-control" id="add_logo" name="brand_type_img">
                                <div class="row">
                                    <label for="recipient-name" class="col-form-label"> Description </label>
                                    <div class="col-12">
...
@section('js')
    ...
    <script>
        var all_brans_types = {!! $all_brans_types !!}
        var itemtbl = "";
        $(document).ready(function() {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "render": function(data) {
                            if (data) {
                                return '<img  class="avatar-img img-thumbnail rounded-5 itemimg" src="brand_type_images/' +
                                    data +
                                    '" width="40px">';
            ...
            itemtbl.clear();
            itemtbl.rows.add(all_brans_types).draw();
    ...
    <script>
        $('#itemtbl tbody').on('click', '.edit_item', function() {
            ...
            $("#brand_type_id").val(currentRow.find("td:eq(0)").text());
            $("#brand_type_name").val(currentRow.find("td:eq(1)").text());
            ...
            $("#brand_type_desc").val(currentRow.find("td:eq(3)").text());
        ...
        $('#itemtbl tbody').on('click', '.delete_item', function() {
            $("#brand_type_id_delete").val('');
            $("#brand_type_name_delete").val('');
            var currentRow = $(this).closest("tr");
            $("#brand_type_id_delete").val(currentRow.find("td:eq(0)").text());

            $("#brand_type_name_delete").val(currentRow.find("td:eq(1)").text());
    ...
    <script>
        $('#brand_type_image_edit').on('change', function() {
            var input = this;
            var url = $(this).val();
        ...
        $('#add_logo').on('change', function() {
            ...
            if (input.files && input.files[0] && (ext == "gif" || ext == "png" || ext == "jpeg" || ext == "jpg")) {
                var reader = new FileReader();
                reader.onload = function(e) {
                    $("#div_image_brand_type").removeClass('d-none');
