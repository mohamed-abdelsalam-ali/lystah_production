...
@section('content')
    ...
    <div class="main-content">
        <div class="page-content">
            <h1 class="text-center text-info">Brands
            </h1>
            <div class="row">
                <div class="col">
                    <div class="card">
    ...
    <div class="modal fade" id="staticBackdrop_edit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('brand.update', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        ...
                                        <input name="brand_id" id="brand_id" type="hidden" class="form-control">
                                ...
                                <input type="file" class="form-control" name="brand_img" id="brand_image_edit">
                                <div class="row">
                                    <label for="recipient-name" class="col-form-label"> Description </label>
                                    <div class="col-12">
                                        <textarea name="desc" cols="30" rows="5" id="brand_desc" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        <input id="brand_id_delete" name="brand_id" type="hidden" class=""
                                            required="">
                                        <label for="recipient-name" class="col-form-label"> سيتم حذف هذا البراند  </label>

                                        <input id="brand_name_delete" name="name" type="text"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row pt-3 d-none" id="div_image_brand">
                                    <img style="width: 200px; height: 100px;" class="add_logo_image" src=""
                                        class="rounded border" alt="">
                                </div>
                                <input type="file" class="form-control" id="add_logo" name="brand_img">
                                <div class="row">
                                    <label for="recipient-name" class="col-form-label"> Description </label>
                                    <div class="col-12">
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "render": function(data) {
                            if (data) {
                                return '<img  class="avatar-img img-thumbnail rounded-5 itemimg" src="brand_images/' +
                                    data +
                                    '" width="40px">';
            ...
            itemtbl.clear();
            itemtbl.rows.add(all_brands).draw();
    ...
    <script>
        $('#itemtbl tbody').on('click', '.edit_item', function() {
            ...
            $("#brand_id").val(currentRow.find("td:eq(0)").text());
            $("#brand_name").val(currentRow.find("td:eq(1)").text());
            ...
            $("#brand_desc").val(currentRow.find("td:eq(3)").text());
        ...
        $('#itemtbl tbody').on('click', '.delete_item', function() {
            $("#brand_id_delete").val('');
            $("#brand_name_delete").val('');
            var currentRow = $(this).closest("tr");
            $("#brand_id_delete").val(currentRow.find("td:eq(0)").text());
            $("#brand_name_delete").val(currentRow.find("td:eq(1)").text());
    ...
    <script>
        $('#brand_image_edit').on('change', function() {
            var input = this;
            var url = $(this).val();
        ...
        $('#add_logo').on('change', function() {
            ...
            if (input.files && input.files[0] && (ext == "gif" || ext == "png" || ext == "jpeg" || ext == "jpg")) {
                var reader = new FileReader();
                reader.onload = function(e) {
                    $("#div_image_brand").removeClass('d-none');
