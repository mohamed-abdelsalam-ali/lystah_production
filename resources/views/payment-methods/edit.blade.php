                    ...
                    <form method="POST" action="{{ route('payment-methods.update', $paymentMethod) }}">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                ...
                                <input type="checkbox" class="custom-control-input" id="requires_credentials" name="requires_credentials" value="1" {{ old('requires_credentials', $paymentMethod->requires_credentials) ? 'checked' : '' }}>
                        ...
                        <div class="form-group credentials-fields" style="display: none;">
                            ...
                            <div id="credentials-container">
                                @php
                                    ...
                                    if (!empty($oldCredentials) && is_array($oldCredentials)) {
                                        // Use old input if available
                                    ...
                                    } elseif (!empty($paymentMethod->credentials) && is_array($paymentMethod->credentials)) {
                                        // Use model data if no old input
