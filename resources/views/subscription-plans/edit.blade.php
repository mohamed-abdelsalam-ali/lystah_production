                    ...
                    <form action="{{ route('subscription-plans.update', $subscriptionPlan) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('display_name') is-invalid @enderror" 
                                   ...
                                   value="{{ old('display_name', $subscriptionPlan->display_name) }}" required>
                            @error('display_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div id="features-container">
                                @php
                                    $oldFeatures = old('features', $subscriptionPlan->features ?? []);
                                    ...
                                    <div class="feature-item mb-2">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="features[{{ $index }}][name]" 
                                                   value="{{ is_array($feature) ? ($feature['name'] ?? '') : $feature }}" 
