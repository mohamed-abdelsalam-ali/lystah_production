...
@section('content')
    ...
    <div class="main-content">
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body">
                    <button class="btn btn-primary addButton m-1 float-left" data-bs-toggle="modal"
                        data-bs-target="#addEquip"> إضافة </button>
            ...
            <div class="row">
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="equipsDT" class="table table-striped table-bordered cell-border "
                                style="width:100%">
                                <thead style="background:#5fcee78a">
                                    <tr>
                                        <th></th>
                                        <th class="text-center">الإسم عربى</th>
                                        <th class="text-center">الإسم إنجليزى</th>
                                        <th class="text-center sorting sorting_asc"> اصناف ذات صلة</th>
                                        <th class="text-center sorting sorting_asc">Equip Series</th>
    ...
    <div class="modal fade" id="addEquip" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel"> شراء معدة جديدة </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="post" action="{{ route('equip.store') }}" class="needs-validation" novalidate
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="main-tab" data-bs-toggle="tab" data-bs-target="#main"
                                    type="button" role="tab" aria-controls="main" aria-selected="true">Main
                                    Data</button>
                            </li>
                            <li class="nav-item" role="presentation">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="specs-tab" data-bs-toggle="tab" data-bs-target="#specs"
                                    type="button" role="tab" aria-controls="specs" aria-selected="false">Specs</button>
                            </li>
                            <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="main" role="tabpanel"
                                ...
                                <div class="p-2 row">
                                    ...
                                    <div class="col-lg-4 form-group">
                                        ...
                                        <input id="name_eng" name="name_eng" type="text" placeholder="English Name"
                                            class="form-control" required>
                                    </div>
                                    <div class="col-lg-4 form-group">
                                ...
                                <div class="p-2 row ">
                                    <div class="col-lg-4 form-group">
                                        <label for=""> عدد ساعات التغيل</label>

                                        <input id="hours" name="hours" type="number" placeholder="Hours"
                                            class="form-control input-sm">
                                    </div>
                                    <div class="col-lg-4 form-group">
                                        <label for=""> أخر تاريخ صيانة</label>

                                        <input id="last_sevice_date" name="last_sevice_date" type="date"
                                    ...
                                    {{-- <div class="col-lg-3 form-group">
                                        <label for=""> الحد الأدنى للكمبية</label>

                                        <input id="" name="limit_order" type="text"
                            ...
                            <div class="tab-pane fade " id="numbers" role="tabpanel" aria-labelledby="numbers-tab">
                                <button type = "button" id="newEquipNumberRow" class="my-2 btn btn-warning">New
                                    Number</button>
                                <table id="equipNumberTbl">
                                    <tr>
                                        <td><input class="form-control" type="text" name="equipNumber[]"
                                                id=""></td>
                            ...
                            <div class="tab-pane fade" id="specs" role="tabpanel" aria-labelledby="specs-tab">
                                ...
                                <button id="newEquipSpecRow" class="my-2 btn btn-warning">New Row</button>
                                <table id="equipSpecsTbl">
                            ...
                            <div class="tab-pane fade" id="brand" role="tabpanel" aria-labelledby="brand-tab">
                                <div class="row">
                                    <div class="col-lg-6">
                                        TYPE
                                        <select id="equipBrandtypeSlct" class="select2 required form-control">
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        BRAND
                                        <select id="equipBrandSlct" class="select2 required form-control">
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <button class="p-0 m-0 btn btn-ghost-primary" id="selectallmodel"> Select All
                                            Model</button>
                                        <select id="equipModelSlct" class="select2 required form-control">
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        SERIES
                                        <button class="p-0 m-0 btn btn-ghost-primary" id="selectallseries"> Select All
                                            Series</button>
                                        <select id="equipSeriesSlct" class="select2 required form-control">
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="upload__box">
                                    <div class="upload__btn-box">
                                        <label class="upload__btn">
                                            ...
                                            <input type="file" multiple="" name="equipImg[]" data-max_length="20"
    ...
    <div class="modal fade" id="editEquip" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit Equip</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="main-tab-edit" data-bs-toggle="tab"
                                    data-bs-target="#main_edit" type="button" role="tab" aria-controls="main_edit"
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="main_edit" role="tabpanel"
                                ...
                                <div class="p-2 row">
                                    ...
                                    <div class="col-lg-4 form-group">
                                        <label for="">الإسم إنجليزى </label>
                                        <input id="name_eng_edit" name="name_eng_edit" type="text" placeholder="English Name"
                                            class="form-control" required>
                                    </div>
                                    <div class="col-lg-4 form-group">
                                        <label for=""> سنة الصنع</label>
                                ...
                                <div class="p-2 row">
                                    <div class="col-lg-4 form-group">
                                        <label for="">بلد المنشأ </label>
                                        <select id="source_id_edit" name ="source_id_edit" class="select2 required form-control"
                                            required>
                                        </select>
                                    </div>
                                    <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-4 form-group">
                                        <label for=""> الجودة</label>
                                        <select id="quality_id_edit" name="quality_id_edit" class="select2 required form-control"
                                            required>
                                        </select>
                                    </div>
                                ...
                                <div class="p-2 row ">
                                    ...
                                    <div class="col-lg-4 form-group">
                                        ...
                                        <input id="last_sevice_date_edit" name="last_sevice_date_edit" type="date"
                                            placeholder="" class="form-control ">
                                    </div>
                                    <div class="col-lg-4 form-group">
                                        <label for=""> تاريخ الوصول</label>
                                ...
                                {{-- <div class="p-2 row">
                                    ...
                                    <div class="col-lg-6">
                                        <input id="name_eng_edit" name="name_eng_edit" type="text"
                                ...
                                <div class="p-2 row">
                                    <div class="col-lg-6">Service Date
                                        <input id="last_sevice_date_edit" name="last_sevice_date_edit" type="date"
                                            placeholder="" class="form-control ">
                                    </div>
                                    <div class="col-lg-6">Delivery Date
                                ...
                                <div class="p-2 row">
                                    <div class="col-lg-6">
                                        <input id="limit_order_edit" name="limit_order_edit" type="text"
                                            placeholder="Limit Order" class="form-control">
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="">Do you want To Active Limit Order ?</label>
                                        <input type="checkbox" id="flage_limit_order_edit" name="flage_limit_order_edit"
                                            value="1">
                                    </div>
                                </div> --}}
                            </div>

                            <div class="tab-pane fade " id="numbers_edit" role="tabpanel" aria-labelledby="numbers-tab">
                                <button type = "button" id="newEquipNumberRow" class="my-2 btn btn-warning">New
                                    Number</button>
                                <table id="equipNumberTbl_edit">
                                    <tr>
                                        <td><input class="form-control" type="text" name="equipNumber[]"
                                                id=""></td>
                                        <td><select name="supplierSlc_editt[]" class="form-control supplierSlct"
                                                id="supplierSlct_edit"></select></td>
                                        <td>REMOVE</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="tab-pane fade" id="specs_edit" role="tabpanel" aria-labelledby="specs-tab">
                                ...
                                <button id="newEquipSpecRow_edit" class="my-2 btn btn-warning">New Row</button>
                                <table id="equipSpecsTbl_edit">
                            ...
                            <div class="tab-pane fade" id="brand_edit" role="tabpanel" aria-labelledby="brand-tab">
                                <div class="row">
                                    <div class="col-lg-6">
                                        TYPE
                                        <select id="equipBrandtypeSlct_edit" class="select2 required form-control">
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        BRAND
                                        <select id="equipBrandSlct_edit" class="select2 required form-control">
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <button class="p-0 m-0 btn btn-ghost-primary" id="selectallmodel"> Select All
                                            Model</button>
                                        <select id="equipModelSlct_edit" class="select2 required form-control">
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        SERIES
                                        <button class="p-0 m-0 btn btn-ghost-primary" id="selectallseries"> Select All
                                            Series</button>
                                        <select id="equipSeriesSlct_edit" class="select2 required form-control">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="image_edit" role="tabpanel" aria-labelledby="image-tab">
                                <div class="upload__box">
                                    <div class="upload__btn-box">
                                        <label class="upload__btn">
                                            <p class="m-0">Upload Images</p>
                                            <input type="file" multiple="" name="equipImg_edit[]"
                                                data-max_length="20" class="upload__inputfile">
                                        </label>
                                    </div>
    ...
    @section('js')
        ...
        <script src="{{ URL::asset('js/equips.js') }}"></script>
        <script>
            (function() {
                'use strict'
