...
@section('content')
    ...
    <div class="main-content">
        <div class="page-content">
            <h1 class="text-center text-info">Currency Types</h1>
            <div class="row">
                <div class="col">
                    <div class="card">
                        <div class="card-head">
                        ...
                        <div class="card-body">
                            <table id="itemtbl" class="display table table-bordered dt-responsive dataTable dtr-inline"
                                ...
                                <thead>
                                    <tr>
                                        <th class="d-none">currency_type_id</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit Currency Type</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('currency_type.update', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        ...
                                        <input id="currency_id" name="currency_id" type="hidden" class="form-control"
                                            required="">
                                        <input id="currency_name" name="name" type="text" class="form-control"
                                            required="">
                                    </div>
                                ...
                                <div class="row p-3">
                                    <label for="recipient-name" class="col-form-label"> Currency description </label>
                                    <div class="col-12">
    ...
    <div class="modal fade" id="staticBackdrop_delete" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Delete Currency Type</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('currency_type.destroy', 'test') }}" method="post">
                    {{ method_field('Delete') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        <input id="currency_id_delete" name="currency_id" type="hidden" class=""
                                            required="">
                                        <label for="recipient-name" class="col-form-label"> سيتم حذف هذا النوع من العملة </label>

                                        <input id="currency_name_delete" name="name" type="text"
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel"> Add New Currency Type</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('currency_type.store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-body">
...
@section('js')
    ...
    <script>
        var all_currency_types = {!! $all_currency_types !!}
        var itemtbl = "";
        $(document).ready(function() {
            itemtbl = $("#itemtbl").DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        <a class="btn btn-success text-nowrap" href="show_currency/${row.id}">show All Currents  </a>
                        `;
                        }
            ...
            itemtbl.clear();
            itemtbl.rows.add(all_currency_types).draw();
    ...
    <script>
        $('#itemtbl tbody').on('click', '.edit_item', function() {
            ...
            $("#currency_name").val(currentRow.find("td:eq(1)").text());
            $("#currency_desc").val(currentRow.find("td:eq(2)").text());
