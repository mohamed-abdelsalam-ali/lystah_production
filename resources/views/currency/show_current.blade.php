...
@section('content')
    ...
    <div class="main-content">
        <div class="page-content">
            <h1 class="text-center text-info"> All Currents
                for <span class="text-danger">{{ $currency_type->name }} .</span>
            </h1>
            <div class="row">
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="itemtbl" class="display table table-bordered dt-responsive dataTable dtr-inline"
                                ...
                                <thead>
                                    <tr>
                                        <th class="d-none">currency_id</th>
                                        <th class="sorting sorting_asc">Value</th>
                                        <th>From</th>
                                        <th>To</th>
                                        <th>Description</th>
                                        <th></th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit Currency Value</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('currency.update', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-6">
                                        <label for="recipient-name" class="col-form-label"> Currency Name </label>
                                        <input name="currency_id" id="currency_id" type="hidden" class="form-control"
                                            value="{{ $currency_type->id }}">
                                        <input name="name" type="text"  class="form-control"
                                            value="{{ $currency_type->name }}" readonly>
                                    </div>
                                    <div class="col-6">
                                        <label for="recipient-name" class="col-form-label"> Value </label>
                                        <input name="value" type="text" id="currency_value" class="form-control" required="">
                                    </div>
                                ...
                                <div class="row p-3">
                                    <div class="col-6">
                                        ...
                                        <input name="from" type="text"  id="currency_from" class="form-control" readonly>
                                    </div>
                                    <div class="col-6">
                                        <label for="recipient-name" class="col-form-label"> To </label>

                                        <input name="from" type="text"  id="currency_to" class="form-control" readonly>
                                    </div>
                                ...
                                <div class="row p-3">
                                    ...
                                    <div class="col-12">
                                        <textarea name="desc"  id="currency_desc" cols="30" rows="5" class="form-control"></textarea>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="staticBackdrop_delete" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Delete  Currency Value</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        <input id="currency_id_delete" name="currency_id" type="hidden"
                                            class="" required="">
                                        <label for="recipient-name" class="col-form-label"> سيتم حذف هذه القيمة  </label>

                                        <input id="currency_name_delete" name="name" type="text" class="form-control"
                                            readonly>
                                    </div>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel"> Add New  Currency Value </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row p-3">
                                    <div class="col-6">
                                        <label for="recipient-name" class="col-form-label"> Currency Name </label>
                                        <input name="currency_id" type="hidden" class="form-control"
                                            value="{{ $currency_type->id }}">
                                        <input name="name" type="text" class="form-control"
                                            value="{{ $currency_type->name }}" readonly>
                                    </div>
                                ...
                                <div class="row p-3">
                                    <div class="col-12">
                                        ...
                                        <input name="from" type="date" class="form-control currency_date" required="">
                                    </div>
...
@section('js')
            ...
            itemtbl = $("#itemtbl").DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        className: "dt-center editor-editt d-none",
    ...
    <script>
        $('#itemtbl tbody').on('click', '.edit_item', function() {
            ...
            $("#currency_id").val(currentRow.find("td:eq(0)").text());
            $("#currency_value").val(currentRow.find("td:eq(1)").text());
            $("#currency_from").val(currentRow.find("td:eq(2)").text());
            $("#currency_to").val(currentRow.find("td:eq(3)").text());
            $("#currency_desc").val(currentRow.find("td:eq(4)").text());


        });

        $('#itemtbl tbody').on('click', '.delete_item', function() {
            $("#currency_id_delete").val('');
            $("#currency_name_delete").val('');
            var currentRow = $(this).closest("tr");
            $("#currency_id_delete").val(currentRow.find("td:eq(0)").text());
            $("#currency_name_delete").val(currentRow.find("td:eq(1)").text());
