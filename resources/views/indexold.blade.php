                        ...
                        <div class="card card-animate" >
                             <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-2">
                                        <div>
                                            <h4 class="fs-18 fw-semibold ff-secondary mb-4 text-black"><span class="counter-value "
                                                data-target="{{ $sum_Buy_Total }}"></span>ج.م
                                            </h4>
                                            <a href="/storeManage" class="text-decoration-underline text-muted">إظهار التفاصيل</a>
                                        </div>
                                        <div class="avatar-sm flex-shrink-0">
                                            <span class="avatar-title bg-soft-primary bg-soft-primary bg-info-subtle rounded fs-3">
                             ...
                             <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-2">
                                        <div>
                                            ...
                                            <a href="/sellInvoices" class="text-decoration-underline text-muted">إظهار التفاصيل</a>
                                        </div>
                                        <div class="avatar-sm flex-shrink-0">
                                            <span class="avatar-title bg-soft-primary bg-soft-primary bg-info-subtle rounded fs-3">
                                                <i class="bx bx-shopping-bag text-info"></i>
                        ...
                        <div class="card card-animate" >
                             <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0">
                                            <h4 class="text-success fs-20 mb-0"> <a href="/Supplierinvoice/{{ $buy_Invoice_last['supplier']->id }}">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-2">
                                        <div>
                                            <h4 class="fs-18 fw-semibold ff-secondary mb-4 text-black"><span class="counter-value "
                                               data-target="{{ $buy_Invoice_last->total_price }}"></span>   {{ $buy_Invoice_last->currency_type->name }}
                                            </h4>
                                            <a href="/printBuyInvoice/{{ $buy_Invoice_last->id }}" class="text-decoration-underline text-muted">إظهار التفاصيل</a>
                                        </div>
                                        <div class="avatar-sm flex-shrink-0">
                                            <span class="avatar-title bg-soft-primary bg-soft-primary bg-info-subtle rounded fs-3">
                                                <i class="bx bx-shopping-bag text-info"></i>
                        ...
                        <div class="card card-animate" >
                             <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0">
                                            <h4 class="text-success fs-20 mb-0"> <a href="/getclientinvoice/{{ $sell_Invoice_last['client']->id }}">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-2">
                                        <div>
                                            <h4 class="fs-18 fw-semibold ff-secondary mb-4 text-black"><span class="counter-value "
                                                data-target="{{ $sell_Invoice_last->actual_price }}"></span>ج.م
                                            </h4>
                                            <a href="/printInvoice/{{ $sell_Invoice_last->id }}" class="text-decoration-underline text-muted">إظهار التفاصيل</a>
                                        </div>
                                        <div class="avatar-sm flex-shrink-0">
                                            <span class="avatar-title bg-soft-primary bg-soft-primary bg-info-subtle rounded fs-3">
                                                <i class="bx bx-shopping-bag text-info"></i>
                        ...
                        <div class="card card-animate" >
                             <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-2">
                                        <div>
                                            <h4 class="fs-18 fw-semibold ff-secondary mb-4 text-black"><span class="counter-value "
                                                data-target="{{ $presalorder_last->total }}"></span>ج.م
                                            </h4>
                                            <a href="/printpreSale/ar/{{ $presalorder_last->id }}/0" class="text-decoration-underline text-muted">إظهار التفاصيل</a>
                                        </div>
                                        <div class="avatar-sm flex-shrink-0">
                                            <span class="avatar-title bg-soft-primary bg-soft-primary bg-info-subtle rounded fs-3">
                                                <i class="bx bx-shopping-bag text-info"></i>
