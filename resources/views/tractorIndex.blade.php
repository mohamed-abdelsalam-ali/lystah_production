...
@section('content')
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                        <h4 class="mb-sm-0">Trctors</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">Tractors</li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <button class="btn btn-primary m-1 float-left" data-bs-toggle="modal" data-bs-target="#addTractor">إضافة
                    </button>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive">
                            <table id="tractorsDT" class="table table-striped table-bordered cell-border "
                                style="width:100%">
                                <thead style="background:#5fcee78a">
                                    <tr>
                                        ...
                                        <th class="text-center sorting sorting_asc">Tractor Series</th>
                                        <th class="text-center sorting sorting_asc">Tractor Brand</th>
                                        <th class="text-center">صور الجرار</th>
    ...
    <div class="modal fade" id="addTractor" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel"> شراء جرار جديد</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="post" action="{{ route('tractor.store') }}" class="needs-validation " novalidate
                    ...
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="main" role="tabpanel"
                                ...
                                <div class="p-2 row">
                                    <div class="col-lg-3">
                                        ...
                                        <input id="" name="name" type="text" placeholder="Arabic Name"
                                            class="form-control" required>
                                    </div>
                                    <div class="col-lg-3">
                                        <label for="">الإسم إنجليزى </label>

                                        <input id="" name="name_en" type="text" placeholder="English Name"
                                            class="form-control" required>
                                    </div>
                                    <div class="col-lg-3">
                                        <label for="">رقم الشاسية </label>

                                        <input id="" name="tractor_number" type="text"
                                ...
                                <div class="p-2 row">
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <select id="source_id" name ="source_id" class="select2 required form-control"
                                            required>
                                        </select>
                                    </div>
                                    <div class="col-lg-3 form-group">
                                        <label for=""> الحالة</label>
                                        <select id="status_id" name ="status_id" class="select2 required form-control"
                                            required>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-3  form-group">
                                        ...
                                        <select id="quality_id" name="quality_id" class="select2 required form-control"
                                            required>
                                        </select>
                                    </div>
                                    <div class="col-lg-3 form-group">
                                ...
                                <div class="p-2 row">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input id="tank_capacity" name="tank_capacity" type="number"
                                            placeholder="Tank Capacity" class="form-control" required>
                                    </div>
                                    <div class="col-lg-3">
                                        <label for="">رقم موتور الجرار </label>

                                        <input id="motornumber" name="motornumber" type="text"
                                ...
                                <div class="p-2 row">
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <select id="frontTire" name ="fronttire" class="select2 required form-control"
                                            required>
                                        </select>
                                    </div>
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <select id="rearTire" name="reartire" class="select2 required form-control"
                                            required>
                                        </select>
                                    </div>
                                    <div class="col-lg-3">
                                        ...
                                        <input id="fronttirestatus" name="fronttirestatus" type="text"
                                            placeholder="Front tire status %" class="form-control">
                                    </div>
                                    <div class="col-lg-3">
                                        <label for=""> حالة الكاوتش الخلفى </label>

                                        <input id="reartirestatus" name="reartirestatus" type="text"
                                ...
                                <div class="p-2 row">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input id="discs" name="discs" type="text" placeholder="Clutch disk"
                                            class="form-control">
                                    </div>
                                    <div class="col-lg-3">
                            ...
                            <div class="tab-pane fade " id="numbers" role="tabpanel" aria-labelledby="numbers-tab">
                                <button type = "button" id="newTractorNumberRow" class="my-2 btn btn-warning">New
                                    Number</button>
                                <table id="tractorNumberTbl">
                                    <tr>
                                        <td><input class="form-control" type="text" name="tractorNumber[]"
                                                id=""></td>
                                        <td><select name="supplierSlct[]" class="select2 form-control supplierSlct"
                            ...
                            <div class="tab-pane fade" id="specs" role="tabpanel" aria-labelledby="specs-tab">
                                ...
                                <button id="newTractorSpecRow" class="my-2 btn btn-warning">New Row</button>
                                <table id="tractorSpecsTbl">
                            ...
                            <div class="tab-pane fade" id="brand" role="tabpanel" aria-labelledby="brand-tab">
                                <div class="row">
                                    <div class="col-lg-6">
                                        TYPE
                                        <select id="tractorBrandtypeSlct" required class="select2 required form-control">
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        BRAND
                                        <select id="tractorBrandSlct" required class="select2 required form-control">
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <button class="p-0 m-0 btn btn-ghost-primary"  id="selectallmodel"> Select All
                                            Model</button>
                                        <select id="tractorModelSlct" required class="select2 required form-control">
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        SERIES
                                        <button class="p-0 m-0 btn btn-ghost-primary" id="selectallseries"> Select All
                                            Series</button>
                                        <select id="tractorSeriesSlct" required class="select2 required form-control">
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="upload__box">
                                    <div class="upload__btn-box">
                                        <label class="upload__btn">
                                            ...
                                            <input type="file" multiple="" name="tractorImg[]"
                            ...
                            <div class="tab-pane fade" id="efragImage" role="tabpanel" aria-labelledby="efragEmage-tab">
                                <div class="upload__box">
                                    <div class="upload__btn-box">
                                        <label class="upload__btn">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="submit" id="inserFormBtn" class="btn btn-danger">Save</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="editTractor" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit Tractor</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <input type="hidden" id="tractor_id" name="tractor_id">
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="main-tabEdit" data-bs-toggle="tab"
                                    data-bs-target="#mainEdit" type="button" role="tab" aria-controls="main"
                                    aria-selected="true">Main Data</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-none" id="numbers-tab" data-bs-toggle="tab"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="specs_edit-tab" data-bs-toggle="tab"
                                    data-bs-target="#specs_edit" type="button" role="tab"
                                    aria-controls="specs_edit" aria-selected="false">Specs</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="brand_edit-tab" data-bs-toggle="tab"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="image_edit-tab" data-bs-toggle="tab"
                                    data-bs-target="#image_edit" type="button" role="tab"
                                    aria-controls="image_edit" aria-selected="false">Images</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="efargImage_edit-tab" data-bs-toggle="tab"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="invoiceImage_edit-tab" data-bs-toggle="tab"
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="mainEdit" role="tabpanel"
                                aria-labelledby="main-tabEdit">
                                <div class="p-2 row">
                                    <div class="col-lg-3">
                                        <label for="">الإسم عربى </label>

                                        <input id="name_edit" name="name_edit" type="text" placeholder="Arabic Name"
                                            class="form-control" required>
                                    </div>
                                    <div class="col-lg-3">
                                        <label for="">الإسم إنجليزى </label>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input id="tractor_number_edit" name="tractor_number_edit" type="text"
                                            placeholder="Chassis No." class="form-control" required>
                                    </div>
                                    <div class="col-lg-3">
                                        <label for=""> الدفع</label>
                                ...
                                <div class="p-2 row">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <label for="">ناق الحركة </label>
                                        <select id="gear_box_edit" name="gear_box_edit"
                                ...
                                <div class="p-2 row">
                                    ...
                                    <div class="col-lg-3">
                                        <label for=""> سعة التانك</label>

                                        <input id="tank_capacity_edit" name="tank_capacity_edit" type="number"
                                            placeholder="Tank Capacity" class="form-control">
                                    </div>
                                    <div class="col-lg-3">
                                        <label for=""> رقم الماتور</label>

                                        <input id="motornumber_edit" name="motornumber_edit" type="text"
                                            placeholder="Motor Number" class="form-control input-sm" required>
                                    </div>
                                </div>
                                ...
                                <div class="p-2 row">
                                    <div class="col-lg-3">
                                        ...
                                        <label for="">مقاس الكاوتش الأمامى</label>
                                        <select id="frontTire_edit" name ="fronttire_edit"
                                            class="select2 required form-control">
                                        </select>
                                    </div>
                                    <div class="col-lg-3">
                                        ...
                                        <label for="">مقاس الكاوتش الخلفى</label>
                                        <select id="rearTire_edit" name="reartire_edit"
                                            class="select2 required form-control">
                                        </select>
                                    </div>
                                    <div class="col-lg-3">
                                        ...
                                        <input id="fronttirestatus_edit" name="fronttirestatus_edit" type="text"
                                            placeholder="Front tire status %" class="form-control">
                                    </div>
                                    <div class="col-lg-3">
                                        <label for=""> حالة الكاوتش الخلفى</label>

                                        <input id="reartirestatus_edit" name="reartirestatus_edit" type="text"
                                            placeholder="Rear tire status %" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="p-2 row">
                                    ...
                                    <div class="col-lg-3">أخر ميعاد للصيانة
                                        <input id="serivcedate_edit" name="serivcedate_edit" type="date"
                                            placeholder="" class="form-control ">
                                    </div>
                                    <div class="col-lg-3"> تاريخ الوصول
                                        <input id="deliverydate_edit" name="deliverydate_edit" type="date"
                                ...
                                <div class="p-2 row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <input id="desc_edit" name="desc_edit" type="text" placeholder="Description"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="specs_edit" role="tabpanel" aria-labelledby="specs_edit-tab">
                                <button id="newTractorSpecRowEdit" class="my-2 btn btn-warning">New Row</button>
                                <table id="tractorSpecsTblEdit">
                                </table>
                            </div>
                            <div class="tab-pane fade" id="brand_edit" role="tabpanel" aria-labelledby="brand_edit-tab">
                                <div class="row">
                                    <div class="col-lg-6">
                                        TYPE
                                        <select id="tractorBrandtypeSlctEdit" class="select2 required form-control">
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        BRAND
                                        <select id="tractorBrandSlctEdit" class="select2 required form-control">
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <button class="p-0 m-0 btn btn-ghost-primary" id="selectallmodel"> Select All
                                            Model</button>
                                        <select id="tractorModelSlctEdit" class="select2 required form-control">
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        SERIES
                                        <button class="p-0 m-0 btn btn-ghost-primary" id="selectallseries"> Select All
                                            Series</button>
                                        <select id="tractorSeriesSlctEdit" class="select2 required form-control">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="image_edit" role="tabpanel" aria-labelledby="image-tab">
                                <div class="upload__box">
                                    <div class="upload__btn-box">
                                        <label class="upload__btn">
                                            <p class="m-0">Upload Images</p>
                                            <input type="file" multiple="" name="tractorImg_edit[]"
                                                data-max_length="20" class="upload__inputfile">
                                        </label>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="efragImage_edit" role="tabpanel"
                                ...
                                <div class="upload__box">
                                    ...
                                    <div class="upload__img-wrap_editRelease"></div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="invoiceImage_edit" role="tabpanel"
                                ...
                                <div class="upload__box">
                                    ...
                                    <div class="upload__img-wrap_editInvoice"></div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="submit" id="editFormBtn" class="btn btn-danger">Save</button>
                    </div>
                </form>
            </div>
        </div>
...
@section('js')
    ...
    <script src="{{ URL::asset('js/tractors.js') }}"></script>
    <script>
        (function() {
            'use strict'
