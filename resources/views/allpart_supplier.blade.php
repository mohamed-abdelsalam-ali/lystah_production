...
<div class="main-content">
    <div class="page-content">
        <h1 class="text-center text-info">Parts</h1>
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-head">
                        ...
                        <table id="partNumbersDT" class="display text-center table table-bordered dt-responsive dataTable dtr-inline"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center sorting sorting_asc">بلد المنشأ </th>
                                    <th class="text-center sorting sorting_asc">الحالة</th>
...
$(document).ready(function () {
    ...
    table = $('#partNumbersDT').DataTable({
        ...
        deferRender: true,
        destroy: true,
        ajax: "/allpartsUnderSupplier/"+{{ $supplier_id }},
        async: false,
        columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex' , "orderable" : false},
            {data: 'number', name: 'number', "orderable" : true},
            {data: 'eng_name', name: 'eng_name', "orderable" : true},
            {data: 'partName', name: 'Part name', "orderable" : true},
            {data: 'Source', name: 'source Name', "orderable" : true},
            {data: 'Status', name: 'status Name', "orderable" : true},
            {data: 'quality', name: 'quality Name', "orderable" : true},
