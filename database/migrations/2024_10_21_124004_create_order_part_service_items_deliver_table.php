...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_part_service_items_deliver', function (Blueprint $table) {
            $table->integer('id', true);
            $table->integer('order_part_service_deliver_id')->nullable()->index('order_part_service_deliver_id');
    ...
    {
        Schema::dropIfExists('order_part_service_items_deliver');
    }
};
