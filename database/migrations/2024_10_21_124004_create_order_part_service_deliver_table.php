...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_part_service_deliver', function (Blueprint $table) {
            ...
            $table->integer('pricing_type_id')->nullable()->index('pricing_type_id');
    ...
    {
        Schema::dropIfExists('order_part_service_deliver');
    }
};
