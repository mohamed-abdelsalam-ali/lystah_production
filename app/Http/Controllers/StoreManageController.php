...
class StoreManageController extends Controller
{
    ...
    public function storeManage2_old(Request $request)
    {
        // return 'tawze3';
        // return $request;
                    ...
                    if ($total >=( $request->invPaied * $all_currency_types[0]->currencies[0]->value )) {
                        ...
                        if ($bank) {
                            ...
                            if ($Ac_allTotal) {
                                ...
                                if($request->invPaied * $all_currency_types[0]->currencies[0]->value  > 0) {
                                        BankSafeMoney::create([
                                        ...
                                        $newqayd->currency_id = $request->currency_id;
                                        $newqayd->credit =  $request->invAllTotalinvPaied * $Ac_all_currency_types[0]->currencies[0]->value+ $buyCoastAc;
                                        $newqayd->debit = '0';
